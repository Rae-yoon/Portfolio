...
set -a
source /home/user_rae/Documents/project/config/public.sh && source /home/user_rae/Documents/project/personal/.personal.sh
set +a
        
export r_title="Maya Render Assets | turntable | char - boy_v002"
export r_priority=100
export r_projects=CUSTOM_PROJECT
export r_cmt="turntable test"
...
export tt_cam=turntable_cam1
                                                                                                

export tt_grp=turntable_asset_grp
export tt_sh=/home/user_rae/Documents/project/public/render/asset/logs/char_boy_v002_td_rae_2025_08_21_12_40_39.sh        
export tt_alf=
